    ...
    public partial class AdminMEbookForm : KryptonForm
    {
       MySqlConnection Con = new MySqlConnection("host=localhost;user=root;password=;database=ebooklibrary");
        ...
        private void kryptonButton4_Click_2(object sender, EventArgs e) //ลบแอดมิน Delete Admin
        {
            ...
            {
                if (MessageBox.Show("คุณต้องการลบอีบุ๊คหรือไม่", "ยืนยัน", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    Con.Open();
        ...
        {
            txtebookid.Text = null;
            txtebookname.Text = null;
            txtebooktype.Text = null;
            txtebookauthor.Text = null;
            txtpdf.Text = null;
        ...
        private void btedit_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show("คุณต้องการอัพเดตอีบุ๊คหรือไม่", "ยืนยัน", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    Con.Open();
        ...
        private void DGVAdmin_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            btadminpic.Image = Image.FromFile(Application.StartupPath + @"\EbookImg\" + imagetext.Text, true);
        }
